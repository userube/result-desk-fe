      ...
      <Card>
        ...
        <CardContent>
          <form className="grid gap-4 md:grid-cols-2">
            {["Week number", "Class", "Topics taught", "Attendance summary", "Student concerns", "Assignments/tests given", "Behaviour notes", "Needs from management", "General comment"].map((field) => (
